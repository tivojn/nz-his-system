  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-500 mt-1">Public hospital waitlist management — {waiting.length} patients waiting</p>
      </div>

      {/* Priority Legend */}
      <div className="flex gap-4 text-sm">
        <div className="flex items-center gap-1"><div className="w-3 h-3 rounded-full bg-red-500" /> Urgent</div>
        <div className="flex items-center gap-1"><div className="w-3 h-3 rounded-full bg-yellow-500" /> Semi-urgent</div>
        <div className="flex items-center gap-1"><div className="w-3 h-3 rounded-full bg-green-500" /> Routine</div>
      </div>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    <div className="flex items-center gap-2">
                      ...
                      <Badge className={`text-xs capitalize ${style.badge}`}>{entry.priority}</Badge>
                    </div>
                  ...
                  <div className="text-right">
                    ...
                    <p className="text-xs text-gray-400">days waiting</p>
                    {entry.targetDate && (
